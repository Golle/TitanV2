...
{
    public static Guid* IID_ID3D12InfoQueue => AsPointer(new byte[] { 0x0b, 0xa9, 0x42, 0x07, 0x87, 0xc3, 0x3f, 0x48, 0xb9, 0x46, 0x30, 0xa7, 0xe4, 0xe6, 0x14, 0x58 });
    public static Guid* IID_ID3D12InfoQueue1 => AsPointer(new byte[] { 0x88, 0xdd, 0x52, 0x28, 0x84, 0xb4, 0x0c, 0x4c, 0xb6, 0xb1, 0x67, 0x16, 0x85, 0x00, 0xe6, 0x00 });
    public static Guid* IID_ID3D12QueryHeap => AsPointer(new byte[] { 0xae, 0x58, 0x96, 0x0d, 0x45, 0xed, 0x9e, 0x46, 0xa6, 0x1d, 0x97, 0x0e, 0xc5, 0x83, 0xca, 0xb4 });
    ...
    public static Guid* IID_ID3D12Device7 => AsPointer(new byte[] { 0x53, 0x4b, 0x01, 0x5c, 0xa1, 0x68, 0x9b, 0x4b, 0x8b, 0xd1, 0xdd, 0x60, 0x46, 0xb9, 0x35, 0x8b });
    ...
    public static Guid* IID_ID3D12GraphicsCommandList4 => AsPointer(new byte[] { 0x8e, 0x31, 0x54, 0x87, 0xa9, 0xd3, 0x41, 0x45, 0x98, 0xcf, 0x64, 0x5b, 0x50, 0xdc, 0x48, 0x74 });
    public static Guid* IID_ID3D12StateObject => AsPointer(new byte[] { 0x43, 0x69, 0x01, 0x47, 0xa8, 0xfc, 0x94, 0x45, 0x93, 0xea, 0xaf, 0x25, 0x8b, 0x55, 0x34, 0x6d });
    ...
    public static Guid* IID_IDXCBlobUtf8 => AsPointer(new byte[] { 0xc9, 0x36, 0xa6, 0x3d, 0x71, 0xba, 0x24, 0x40, 0xa3, 0x01, 0x30, 0xcb, 0xf1, 0x25, 0x30, 0x5b });
    ...
    public static Guid* IID_IDXGIDebug => AsPointer(new byte[] { 0x52, 0x74, 0x9e, 0x11, 0x9e, 0xde, 0xfe, 0x40, 0x88, 0x06, 0x88, 0xf9, 0x0c, 0x12, 0xb4, 0x41 });
    ...
    public static Guid* DXGI_DEBUG_ALL => AsPointer(new byte[] { 0x83, 0xE2, 0x8A, 0xE4, 0x80, 0xDA, 0x0B, 0x49, 0x87, 0xE6, 0x43, 0xE9, 0xA9, 0xCF, 0xDA, 0x08 });
