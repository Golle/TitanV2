...
public unsafe struct IXAudio2 : INativeGuid
{
    ...
    public HRESULT CreateMasteringVoice(
        ...
        XAUDIO2_EFFECT_CHAIN* pEffectChain = null,
        AudioStreamCategory streamCategory = AudioStreamCategory.AudioCategory_GameEffects
    )
        => ((delegate* unmanaged[Stdcall]<void*, IXAudio2MasteringVoice**, uint, uint, uint, char*, XAUDIO2_EFFECT_CHAIN*, AudioStreamCategory, HRESULT>)_vtbl[7])(Unsafe.AsPointer(ref this), ppMasteringVoice, inputChannels, inputSampleRate, flags, szDeviceId, pEffectChain, streamCategory);
