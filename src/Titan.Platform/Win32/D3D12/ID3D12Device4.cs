...
public unsafe struct ID3D12Device4 : INativeGuid
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public HRESULT CreateSharedHandle(ID3D12DeviceChild* pObject, SecurityAttributes* pAttributes, uint Access, char* Name, HANDLE* pHandle)
        => ((delegate* unmanaged[Stdcall]<void*, ID3D12DeviceChild*, SecurityAttributes*, uint, char*, HANDLE*, HRESULT>)_vtbl[31])(Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
