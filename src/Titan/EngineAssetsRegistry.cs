...
public readonly struct EngineAssetsRegistry : Titan.Assets.IAssetRegistry
{
    ...
    public static ref readonly Titan.Assets.AssetDescriptor RedSheet => ref _assets[5];
    public static ref readonly Titan.Assets.AssetDescriptor ShaderDeferredLightingPixel => ref _assets[6];
    public static ref readonly Titan.Assets.AssetDescriptor ShaderDeferredLightingVertex => ref _assets[7];
    public static ref readonly Titan.Assets.AssetDescriptor ShaderFullscreenPixel => ref _assets[8];
    public static ref readonly Titan.Assets.AssetDescriptor ShaderFullscreenVertex => ref _assets[9];
    public static ref readonly Titan.Assets.AssetDescriptor ShaderGBufferPixel => ref _assets[10];
    public static ref readonly Titan.Assets.AssetDescriptor ShaderGBufferVertex => ref _assets[11];
    public static ref readonly Titan.Assets.AssetDescriptor SimplePixelShader => ref _assets[12];
    public static ref readonly Titan.Assets.AssetDescriptor SimpleVertexShader => ref _assets[13];
    public static ref readonly Titan.Assets.AssetDescriptor TheModel => ref _assets[14];
    public static ref readonly Titan.Assets.AssetDescriptor TitanLogo => ref _assets[15];
