...
internal sealed unsafe class SystemsScheduler : ISystemsScheduler
{
    ...
    public bool Init(IMemoryManager memoryManager, IJobSystem jobSystem, ImmutableArray<SystemDescriptor> systems, IUnmanagedResources unmanaged, IManagedServices services)
    {
