...
public readonly struct EngineRegistry : Titan.Assets.IAssetRegistry
{
    ...
    public static ref readonly Titan.Assets.AssetDescriptor Female => ref _assets[2];
    public static ref readonly Titan.Assets.AssetDescriptor FullScreenVertexShader => ref _assets[3];
    public static ref readonly Titan.Assets.AssetDescriptor RedSheet => ref _assets[4];
    public static ref readonly Titan.Assets.AssetDescriptor SimplePixelShader => ref _assets[5];
    public static ref readonly Titan.Assets.AssetDescriptor SimpleVertexShader => ref _assets[6];
    public static ref readonly Titan.Assets.AssetDescriptor TheModel => ref _assets[7];
    public static ref readonly Titan.Assets.AssetDescriptor TitanLogo => ref _assets[8];
    static EngineRegistry()
    {
        ...
        _assets[2] = new Titan.Assets.AssetDescriptor
        {
            ...
            { 
                ...
                Offset = 4196124,
#if !RELEASE
            AssetPath = Titan.Core.Strings.StringRef.Create(@"testmodels\11091_FemaleHead_v4.obj")
#else
            AssetPath = Titan.Core.Strings.StringRef.Empty
#endif
            },
