...
//    {
//        Logger.Trace<D3D12ModuleOld>("Using D3D12 Rendering");
...
//        {
//            Logger.Error<D3D12ModuleOld>($"Failed to init {nameof(D3D12Adapter)}");
//            return false;
//        }
...
//        {
//            Logger.Warning<D3D12ModuleOld>($"Failed to init {nameof(D3D12DebugLayer)}. D3D12 Debug information might be incomplete.");
//        }
//#endif
//        if (!device.Init(adapters, d3d12Config.FeatureLevel))
//        {
//            Logger.Error<D3D12ModuleOld>($"Failed to init {nameof(D3D12Device)}");
//            return false;
//        }
