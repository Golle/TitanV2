...
internal readonly struct SystemType(INamedTypeSymbol type, IMethodSymbol method, int stage, int executionType, SyntaxNode node, ImmutableArray<SystemParameter> parameters)
{
